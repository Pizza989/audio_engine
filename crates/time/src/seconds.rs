...
impl SecondsF64 {
    ...
    pub fn from_frame_lossy(frame: FrameTime, sample_rate: SampleRate) -> Self {
        frame.to_seconds_f64_lossy(sample_rate)
    }
    ...
    pub fn from_superclock_time_lossy(superclock_time: SuperclockTime) -> Self {
        superclock_time.to_seconds_f64_lossy()
    }
    ...
    /// [`FrameTime`]: struct.FrameTime.html
    /// [`SampleRate`]: struct.SampleRate.html
    pub fn to_nearest_frame_round_lossy(&self, sample_rate: SampleRate) -> FrameTime {
        if self.0 > 0.0 {
    ...
    /// [`FrameTime`]: struct.FrameTime.html
    /// [`SampleRate`]: struct.SampleRate.html
    pub fn to_nearest_frame_floor_lossy(&self, sample_rate: SampleRate) -> FrameTime {
        if self.0 > 0.0 {
    ...
    /// [`FrameTime`]: struct.FrameTime.html
    /// [`SampleRate`]: struct.SampleRate.html
    pub fn to_nearest_frame_ceil_lossy(&self, sample_rate: SampleRate) -> FrameTime {
        if self.0 > 0.0 {
    ...
    /// [`FrameTime`]: struct.FrameTime.html
    /// [`SampleRate`]: struct.SampleRate.html
    pub fn to_sub_frame_lossy(&self, sample_rate: SampleRate) -> (FrameTime, f64) {
        if self.0 > 0.0 {
    ...
    pub fn to_nearest_super_frame_round_lossy(&self) -> SuperclockTime {
        SuperclockTime::from_seconds_f64_lossy(*self)
    }
    ...
    ///
    /// [`SuperclockTime`]: struct.FrameTime.html
    pub fn to_nearest_super_frame_floor_lossy(&self) -> SuperclockTime {
        SuperclockTime::from_seconds_f64_floor_lossy(*self)
    }
    ...
    ///
    /// [`SuperclockTime`]: struct.FrameTime.html
    pub fn to_nearest_super_frame_ceil_lossy(&self) -> SuperclockTime {
        SuperclockTime::from_seconds_f64_ceil_lossy(*self)
    }
    ...
    ///
    /// [`SuperclockTime`]: struct.FrameTime.html
    pub fn to_sub_super_frame_lossy(&self) -> (SuperclockTime, f64) {
        SuperclockTime::from_seconds_f64_with_sub_tick_lossy(*self)
    }
    ...
    pub fn to_musical_lossy(&self, bpm: f64) -> MusicalTime {
        MusicalTime::from_beats_f64_lossy(self.0 * (bpm / 60.0))
    }
}
