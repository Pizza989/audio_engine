...
impl MusicalTime {
    ...
    pub fn from_beats_f64_lossy(beats: f64) -> Self {
        if beats >= 0.0 {
    ...
    pub fn as_beats_f64_lossy(&self) -> f64 {
    ...
    pub fn to_seconds_f64_lossy(&self, bpm: f64) -> SecondsF64 {
        SecondsF64(self.as_beats_f64_lossy() * 60.0 / bpm)
    }
    ...
    pub fn to_nearest_frame_round_lossy(&self, bpm: f64, sample_rate: SampleRate) -> FrameTime {
        self.to_seconds_f64_lossy(bpm)
            .to_nearest_frame_round_lossy(sample_rate)
    }
    ...
    ///
    /// [`FrameTime`]: struct.FrameTime.html
    pub fn to_nearest_frame_floor_lossy(&self, bpm: f64, sample_rate: SampleRate) -> FrameTime {
        self.to_seconds_f64_lossy(bpm)
            .to_nearest_frame_floor_lossy(sample_rate)
    }
    ...
    ///
    /// [`FrameTime`]: struct.FrameTime.html
    pub fn to_nearest_frame_ceil_lossy(&self, bpm: f64, sample_rate: SampleRate) -> FrameTime {
        self.to_seconds_f64_lossy(bpm)
            .to_nearest_frame_ceil_lossy(sample_rate)
    }
    ...
    ///
    /// [`FrameTime`]: struct.FrameTime.html
    pub fn to_sub_frame_lossy(&self, bpm: f64, sample_rate: SampleRate) -> (FrameTime, f64) {
        self.to_seconds_f64_lossy(bpm)
            .to_sub_frame_lossy(sample_rate)
    }
    ...
    pub fn to_nearest_super_frame_round_lossy(&self, bpm: f64) -> SuperclockTime {
        self.to_seconds_f64_lossy(bpm)
            .to_nearest_super_frame_round_lossy()
    }
    ...
    ///
    /// [`SuperclockTime`]: struct.SuperclockTime.html
    pub fn to_nearest_super_frame_floor_lossy(&self, bpm: f64) -> SuperclockTime {
        self.to_seconds_f64_lossy(bpm)
            .to_nearest_super_frame_floor_lossy()
    }
    ...
    ///
    /// [`SuperclockTime`]: struct.SuperclockTime.html
    pub fn to_nearest_super_frame_ceil_lossy(&self, bpm: f64) -> SuperclockTime {
        self.to_seconds_f64_lossy(bpm)
            .to_nearest_super_frame_ceil_lossy()
    }
    ...
    ///
    /// [`SuperclockTime`]: struct.SuperclockTime.html
    pub fn to_sub_super_frame_lossy(&self, bpm: f64) -> (SuperclockTime, f64) {
        self.to_seconds_f64_lossy(bpm).to_sub_super_frame_lossy()
    }
