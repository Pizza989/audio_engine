...
impl FrameTime {
    ...
    pub fn to_seconds_f64_lossy(&self, sample_rate: SampleRate) -> SecondsF64 {
    ...
    pub fn to_musical_lossy(&self, bpm: f64, sample_rate: SampleRate) -> MusicalTime {
        self.to_seconds_f64_lossy(sample_rate).to_musical_lossy(bpm)
    }
    ...
    /// [`SampleRate`]: struct.SampleRate.html
    pub fn to_super_frame_maybe_lossy(&self, sample_rate: SampleRate) -> SuperclockTime {
        SuperclockTime::from_frame_maybe_lossy(*self, sample_rate)
    }
}
